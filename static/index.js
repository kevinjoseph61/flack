document.addEventListener('DOMContentLoaded', function() {
  if (localStorage.getItem('display')) {
    ...
    document.getElementById('set_display').innerHTML = 'Change Username';
  ...
  socket.on('connect', function() {
    ...
    } else {	document.getElementById('channel_view').style.pointerEvents = 'none';
    };
  });
  ...
  socket.on('channel created', function(data) {
	if(x=document.getElementById("chan_mess")){
		x.innerHTML="Or join one of these!";
	}
    console.log(data);
  ...
  socket.on('user joined', function(data) {
    ...
    join_message.innerHTML = data.user + ' has joined the chat!';  document.querySelector('#messages').append(join_message);
  ...
  socket.on('user left', function(data) {
    ...
    leave_message.innerHTML = data.user + ' left the chat';  document.querySelector('#messages').append(leave_message);
  ...
  socket.on('name changed', function(data) {
    ...
    change_message.innerHTML = data.old_name + ' changed their username to ' + data.name;  document.querySelector('#messages').append(change_message);
